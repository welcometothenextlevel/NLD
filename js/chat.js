...
(function () {
  ...
  const KB = [
    ...
    { id: 'work', k: ['portfolio', 'examples', 'projects', 'clients', 'australia', 'experience', 'work', 'realisations', 'realisation', 'exemples', 'exemple', 'portfolio', 'references', 'projets', 'clients', 'australie', 'australiennes', 'experience', 'travaux'],
      ...
      en: "<p>We have worked with small businesses in Australia: beauty studio, care services, cleaning, jewellery, transport, sports club. The sites are live in the <a href=\"/index.html#work\">Our work<\/a> section.<\/p><p>The same care goes to SMEs in French-speaking Switzerland today.<\/p>", enChips: ["Which trades?", "Request a preview"] },
  ...
  const ACTIONS = { 'Demander un aperçu': '/book.html', 'Parler à quelqu’un': WA, 'Voir des réalisations': '/index.html#work', 'Request a preview': '/book.html', 'Talk to a person': WA, 'See our work': '/index.html#work' };
